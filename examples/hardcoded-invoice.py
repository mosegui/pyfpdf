...
pdf.insert(Rectangle(15.0, 15.0, 170.0, 245.0))
pdf.set_line_width(0.0)
pdf.insert(Rectangle(95.0, 15.0, 10.0, 10.0))
pdf.insert(Figure('../tutorial/logo.png', 20.0, 17.0, w=13.0, h=13.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(100.0, 25.0, 100.0, 57.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 57.0, 185.0, 57.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 77.0, 185.0, 77.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 88.0, 185.0, 88.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 95.0, 185.0, 95.0))
pdf.set_line_width(0.0)
pdf.insert(Line(155.0, 95.0, 155.0, 230.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 102.0, 185.0, 102.0))
...
pdf.set_line_width(0.0)
pdf.insert(Line(15.0, 230.0, 185.0, 230.0,))
...
pdf.set_line_width(0.0)
pdf.insert(Rectangle(155.0, 252.0, 25.0, 7.0))
